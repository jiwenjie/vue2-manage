<!-- 人员设置（展示人员列表且点击查看人员详情等） -->
<template>
  <div id="personSettingApp" class="match-height">
    <!-- 头顶的面包屑展示部分 -->
...
import personSetting from "./js/personSetting"

export default {
  name: "personSetting",
  components: { headerBrum },
  mixins: [personSetting],
}
</script>

<style lang="less" scoped>
@import "./css/personSetting.less";
</style>
